<template>
    <div class="promo-container">
        <div class="all-promotions" :class="{ slot: ui.edition === EDITION.SLOT }">
                    ...
                    <div style="position: sticky; top: 0">
                        <div class="type-list">
                            ...
                            <div class="type-item" v-for="p in currentPromoTypes"
                                ...
                                :key="p.code" @click="switchPromoType(p.code)">
...
<script lang="js">
import { ref, defineComponent, onMounted, reactive, inject, computed } from "vue";
...
export default defineComponent({
    ...
    setup() {
        ...
        const banner = ref([]);
        const promoState = inject('promoState');
